...
public class PrintExample {
	...
	public static void main(String[] args) {
		...
		//System.out.println() : 한 줄 출력( 출력 후 줄바꿈 수행 == 개행_)
		//System.out.print()   : 단순 출력 (출력 후 줄바꿈X)
		//줄바꿈 이라는 차이점이 있지만, 괄호안의 내용이 그대로 출력된다는 것은 똑같음
