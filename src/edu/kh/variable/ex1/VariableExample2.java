...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		boolean booleanData;
		//메모리에 논리 값(T/F)을 저장 할 공간을 1byte 할당하고
		//할당 된 공간을 booleanData라고 부르겠다
		
		booleanData = true;
		// = : 대입연산자 ==> 오른쪽에 있는 값을 왼쪽에 대입하겠다.
		System.out.println("booleanData: " + booleanData);
		
		//자료형은 byte 변수명 byteNumbr 값 127 대입
		byte byteNumber = 127;
		
		//메모리에 정수값을 할당 할 공간 1byte 할당하고
		...
		int $antien; // 문제는 없지만 개발자가 직접 사용 안합니다
		int int_number; //자바는 카멜표기법 쓰기때문에 _ 작성 안함
		               // _ 작성 표기법은 DB에서 사용
		
		//5. 카멜표기법
		//-> 변수명 작성 시 여러 단어를 이엇 작성하는 경우
		...
		/*상수(항상 같은 수)
		 * - 변수의 한 종류
		 * - 한번 값이 대입 되면 다른 값 대입 불가능
		 * - 자료형 앞에 final 키워드를 작성(마지막 대입되는 값 이라는 뜻)
		 * 
		 * - 상수 명명 규칙 : 모두 대문자, 여러단어 작성 시 "_" 사용
		 * 
		 * - 상수를 사용하는 경우
		 * 1) 변하면 안되는 고정된 값을 저장 할 때
		 * 2) 특정한 값에 의미를 부여 하는 경우
		 * 
		 * */
